...
fun  LoyaltyPointsScreen(navController: NavHostController) {
    Column(modifier = Modifier.fillMaxSize().background(Color.Black)) {
        ...
        Column(modifier = Modifier.padding(start = 20.dp, end = 20.dp, top = 20.dp)) {
            ...
            LoyaltyPointsBanner(points = 120, onRedeemClick = {})

            Spacer(Modifier.height(10.dp))

            Text(text = "Recent Activity", fontFamily = FontFamily(Font(R.font.urbanist_semibold)), color = Color.White, fontSize = 20.sp)
