 ...
 */
package com.bussiness.komposecountrycodepicker.component
...
import androidx.compose.ui.unit.dp
import com.bussiness.komposecountrycodepicker.R
import com.bussiness.komposecountrycodepicker.annotation.RestrictedApi
import com.bussiness.komposecountrycodepicker.data.Country
import com.bussiness.komposecountrycodepicker.data.FlagSize
import com.bussiness.komposecountrycodepicker.utils.PhoneNumberTransformation
import com.bussiness.komposecountrycodepicker.utils.PickerUtils
import com.bussiness.komposecountrycodepicker.utils.PickerUtils.extractCountryCodeAndPhoneNumber
import com.bussiness.komposecountrycodepicker.utils.PickerUtils.getCountry
import com.bussiness.komposecountrycodepicker.utils.PickerUtils.removeSpecialCharacters
...
//        )
        Image(painter = painterResource(R.drawable.ic_email_icon),
            contentDescription = null,
            )
    },
...
private fun SelectedCountryComponent(
    ...
    showDropdownIcon: Boolean = true // New parameter
) {
    Row(
        modifier = modifier
        ...
        if (showDropdownIcon) { // Conditionally show dropdown icon
            Icon(
